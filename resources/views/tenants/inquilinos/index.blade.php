    ...
    <div class="container">
        ...
        <div class="mb-4 flex justify-end">
            <a href="{{ route('tenants.create') }}"
                class="text-white bg-gray-950 box-border border border-transparent hover:bg-dark-strong focus:ring-4 focus:ring-neutral-tertiary shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none rounded-md">Create
                Inquilino</a>
        </div>
                            ...
                            <tr class="bg-neutral-primary border-b border-default">
                                ...
                                <td class="flex items-center gap-2 px-6 py-4">
                                    ...
                                    <form action="{{ route('tenants.destroy', $tenant->id) }}" method="post">
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            class="text-black bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">Eliminar</button>
                                    </form>
                                </td>
