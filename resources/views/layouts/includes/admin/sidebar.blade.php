...
<div id="sidebar"
    ...
    <div class="flex flex-col h-full">
        <!-- Sidebar Header -->
        <div class="flex items-center justify-between h-[65px] px-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center space-x-3">
                @if ($company && $company->logo_path)
                    <img src="{{ asset($company->logo_path) }}" alt="{{ $company->name }}" class="h-8 w-auto dark:hidden">
                    @if ($company->logo_path_dark)
                        <img src="{{ asset($company->logo_path_dark) }}" alt="{{ $company->name }}"
