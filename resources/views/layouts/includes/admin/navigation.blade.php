        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <button id="sidebar-toggle"
                    ...
                    <svg class="icon-open h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24" style="display: block;">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                    </svg>
                    <svg class="icon-close h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24" style="display: none;">
            ...
            <div class="flex items-center space-x-4">
                ...
                <button class="p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 transition duration-150"
                        style="focus:ring-color: var(--color-one);">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 transition duration-150"
                                style="focus:ring-color: var(--color-one);">
