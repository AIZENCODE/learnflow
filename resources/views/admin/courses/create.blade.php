                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <x-text-input id="slug" name="slug" type="text" class="mt-1 block w-full"
                            :value="old('slug')" placeholder="Se genera automáticamente si se deja vacío" />
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="short_description" name="short_description" rows="2"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm">{{ old('short_description') }}</textarea>
                    ...
                    <div>
                        ...
                        <x-text-input id="order_in_track" name="order_in_track" type="number" class="mt-1 block w-full"
                            :value="old('order_in_track', 0)" min="0" />
                    ...
                    <div>
                        ...
                        <select id="show_media_type" name="show_media_type"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm">
                            <option value="image" {{ old('show_media_type', 'image') == 'image' ? 'selected' : '' }}>Imagen</option>
                            <option value="video" {{ old('show_media_type') == 'video' ? 'selected' : '' }}>Video</option>
                            <option value="none" {{ old('show_media_type') == 'none' ? 'selected' : '' }}>Ninguno</option>
                        </select>
                    ...
                    <div>
                        ...
                        <x-text-input id="xp_points" name="xp_points" type="number" step="0.01" class="mt-1 block w-full"
                            :value="old('xp_points', 0)" min="0" required />
